...
<div class="container mt-5">
    <div class="mb-4">
        <h1 class="display-4">{{ __('Edit Product') }}</h1>
        <p class="lead mb-4">{{ __('Form to edit a product') }}</p>
        <hr>
    </div>
            ...
            <div class="col-md-6">
                <div class="bg-light p-3 rounded mb-4">
                    <div class="mb-3">
                        ...
                        @elseif ($oldImageUrl)
                            <div class="mt-2 position-relative d-inline-block">
                                <img src="{{ $oldImageUrl }}" alt="Current Image" class="img-thumbnail" style="max-width: 150px;">
                            </div>
                        @endif
                    </div>
                    <div class="mb-3">
