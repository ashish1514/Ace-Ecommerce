            ...
            <tbody>
                @forelse ($roles as $role)
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800">
                        <td class="px-6 py-2 text-black">{{ $role['id'] }}</td>
                        ...
                        <td class="px-6 py-2">
                            <div class="flex space-x-2">
                                @can('Role Show')
                                    <a href="{{ route('roles.show', $role['id']) }}" class="bg-green-500 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-lg">Show</a>
                                @endcan
                                @can('Role Edit')
